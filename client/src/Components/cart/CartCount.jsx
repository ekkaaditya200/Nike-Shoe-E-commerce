...
const CartCount = ({onClearCartItems,onCartToggle,totalQTY}) => {
  return (
    ...
    <div className='flex items-center'>
        <button onClick={()=>onClearCartItems(true)} type='button'className='rounded bg-theme-cart active:scale-90 p-0.5'>
